  ...
  return (
    <div className="space-y-6">
      <div className="reveal-up">
        <h1 className="font-display text-3xl font-bold tracking-tight">Manajemen Pesanan</h1>
        <p className="text-muted-foreground">Kelola pesanan pelanggan dan perbarui status pengiriman.</p>
      </div>
